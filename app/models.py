...
class Blog(db.Model):
    ...
    id = db.Column(db.Integer,primary_key = True)
    blogs_topic = db.Column(db.String())
    blogs_content = db.Column(db.String())
    blogs_posted_on =  db.Column(db.DateTime, nullable=False, default = datetime.utcnow)
